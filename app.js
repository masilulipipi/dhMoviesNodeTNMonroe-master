...
// for (let unaPelicula of movies) {
// 	soloTitulos.push(unaPelicula.title);
// }
	...
	.createServer(function (req, res) {
		...
		switch (req.url) {
			case '/':
				...
				contenidoHome += `Total de películas en cartelera​: ${totalMovies} \n\n\n`;
			...
			case '/mas-votadas':
				...
				contenidoMasVotadas += `Total del películas: ${masVotadas.length}\n\n`;
				...
				contenidoMasVotadas += `Rating promedio: ${ratingPromedio}\n\n`;

				masVotadas.forEach(function (unaPelicula) {
					contenidoMasVotadas += `TÍTULO: ${unaPelicula.title} \nRESEÑA: ${unaPelicula.overview}\n\n\n`;
				});
